...
export default async function InvitePage({params}: Props) {
    ...
    if (!result.valid) {
        return (
            <div
                className="min-h-screen flex flex-col items-center justify-center p-4 bg-linear-to-br from-background via-background to-primary/5">
                    ...
                    <div className="p-4 bg-secondary/50 rounded-lg space-y-3">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-sm">
                                    Invited by <span
                                    className="font-medium">{invite.creator.name || invite.creator.email}</span>
                                </p>
                            </div>
                        </div>
                    </div>
